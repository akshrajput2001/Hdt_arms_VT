...
(cl:defclass <HDTHSTelem> (roslisp-msg-protocol:ros-message)
  ((position
    :reader position
    :initarg :position
    :type cl:float
...
(cl:defclass HDTHSTelem (<HDTHSTelem>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <HDTHSTelem>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'HDTHSTelem)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hdt_adroit_driver-msg:<HDTHSTelem> is deprecated: use hdt_adroit_driver-msg:HDTHSTelem instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <HDTHSTelem>))
...
(cl:defmethod velocity-val ((m <HDTHSTelem>))
...
(cl:defmethod effort-val ((m <HDTHSTelem>))
...
(cl:defmethod motor_current-val ((m <HDTHSTelem>))
  ...
  (motor_current m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HDTHSTelem>) ostream)
  "Serializes a message object of type '<HDTHSTelem>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HDTHSTelem>) istream)
  "Deserializes a message object of type '<HDTHSTelem>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HDTHSTelem>)))
  "Returns string type for a message object of type '<HDTHSTelem>"
  "hdt_adroit_driver/HDTHSTelem")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HDTHSTelem)))
  "Returns string type for a message object of type 'HDTHSTelem"
  "hdt_adroit_driver/HDTHSTelem")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HDTHSTelem>)))
  "Returns md5sum for a message object of type '<HDTHSTelem>"
  "1366e8e4333938cc6ba1851fe990fb6a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HDTHSTelem)))
  "Returns md5sum for a message object of type 'HDTHSTelem"
  "1366e8e4333938cc6ba1851fe990fb6a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HDTHSTelem>)))
  "Returns full string definition for message of type '<HDTHSTelem>"
  (cl:format cl:nil "float32 position~%float32 velocity~%float32 effort~%float32 motor_current~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HDTHSTelem)))
  "Returns full string definition for message of type 'HDTHSTelem"
  (cl:format cl:nil "float32 position~%float32 velocity~%float32 effort~%float32 motor_current~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HDTHSTelem>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HDTHSTelem>))
