...
"""autogenerated by genpy from hdt_arm_control/TrajectoryPathActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryPathActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "hdt_arm_control/TrajectoryPathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hdt_arm_control/TrajectoryPathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajectoryPathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hdt_arm_control.msg.TrajectoryPathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hdt_arm_control.msg.TrajectoryPathFeedback()
