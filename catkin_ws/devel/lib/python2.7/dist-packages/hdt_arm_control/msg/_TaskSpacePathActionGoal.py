...
"""autogenerated by genpy from hdt_arm_control/TaskSpacePathActionGoal.msg. Do not edit."""
import codecs
import sys
...
class TaskSpacePathActionGoal(genpy.Message):
  ...
  _type = "hdt_arm_control/TaskSpacePathActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','hdt_arm_control/TaskSpacePathGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = hdt_arm_control.msg.TaskSpacePathGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = hdt_arm_control.msg.TaskSpacePathGoal()
