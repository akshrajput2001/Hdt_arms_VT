...
"""autogenerated by genpy from hdt_arm_control/TrajectoryPathActionResult.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryPathActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hdt_arm_control/TrajectoryPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hdt_arm_control/TrajectoryPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajectoryPathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hdt_arm_control.msg.TrajectoryPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hdt_arm_control.msg.TrajectoryPathResult()
