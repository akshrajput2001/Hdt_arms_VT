...
"""autogenerated by genpy from hdt_adroit_driver/HDTJointState.msg. Do not edit."""
import codecs
import sys
...
class HDTJointState(genpy.Message):
  _md5sum = "de9840a71e6ac8ef70d0fb933aca51fe"
  _type = "hdt_adroit_driver/HDTJointState"
...
string frame_id
"""
  __slots__ = ['header','name','position','velocity','effort','motor_current','bus_voltage','bus_current','temperature','state']
  _slot_types = ['std_msgs/Header','string[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,position,velocity,effort,motor_current,bus_voltage,bus_current,temperature,state
    ...
    """
    if args or kwds:
      super(HDTJointState, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.bus_voltage))
      length = len(self.bus_current)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.bus_current))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.bus_voltage = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.bus_current = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.bus_current.tostring())
      length = len(self.temperature)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.bus_current = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
