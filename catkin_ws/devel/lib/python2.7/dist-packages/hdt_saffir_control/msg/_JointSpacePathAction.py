...
"""autogenerated by genpy from hdt_saffir_control/JointSpacePathAction.msg. Do not edit."""
import codecs
import sys
...
class JointSpacePathAction(genpy.Message):
  _md5sum = "2c94696f2724382682afbb876fec1118"
  _type = "hdt_saffir_control/JointSpacePathAction"
...
"""
  ...
  _slot_types = ['hdt_saffir_control/JointSpacePathActionGoal','hdt_saffir_control/JointSpacePathActionResult','hdt_saffir_control/JointSpacePathActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointSpacePathAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = hdt_saffir_control.msg.JointSpacePathActionGoal()
      if self.action_result is None:
        self.action_result = hdt_saffir_control.msg.JointSpacePathActionResult()
      if self.action_feedback is None:
        self.action_feedback = hdt_saffir_control.msg.JointSpacePathActionFeedback()
    else:
      self.action_goal = hdt_saffir_control.msg.JointSpacePathActionGoal()
      self.action_result = hdt_saffir_control.msg.JointSpacePathActionResult()
      self.action_feedback = hdt_saffir_control.msg.JointSpacePathActionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.pose = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.pose = str[start:end]
      _x = self
      start = end
      end += 12
