...
"""autogenerated by genpy from hdt_saffir_control/TaskSpacePathActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TaskSpacePathActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "hdt_saffir_control/TaskSpacePathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hdt_saffir_control/TaskSpacePathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskSpacePathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hdt_saffir_control.msg.TaskSpacePathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hdt_saffir_control.msg.TaskSpacePathFeedback()
