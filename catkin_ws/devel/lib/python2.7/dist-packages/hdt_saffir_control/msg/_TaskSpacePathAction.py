...
"""autogenerated by genpy from hdt_saffir_control/TaskSpacePathAction.msg. Do not edit."""
import codecs
import sys
...
import hdt_saffir_control.msg
import std_msgs.msg

class TaskSpacePathAction(genpy.Message):
  _md5sum = "720064449a9d177b1b9bd47b330a5f03"
  _type = "hdt_saffir_control/TaskSpacePathAction"
...
"""
  ...
  _slot_types = ['hdt_saffir_control/TaskSpacePathActionGoal','hdt_saffir_control/TaskSpacePathActionResult','hdt_saffir_control/TaskSpacePathActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskSpacePathAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = hdt_saffir_control.msg.TaskSpacePathActionGoal()
      if self.action_result is None:
        self.action_result = hdt_saffir_control.msg.TaskSpacePathActionResult()
      if self.action_feedback is None:
        self.action_feedback = hdt_saffir_control.msg.TaskSpacePathActionFeedback()
    else:
      self.action_goal = hdt_saffir_control.msg.TaskSpacePathActionGoal()
      self.action_result = hdt_saffir_control.msg.TaskSpacePathActionResult()
      self.action_feedback = hdt_saffir_control.msg.TaskSpacePathActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.marker
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.marker = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.marker = str[start:end]
      _x = self
      start = end
      end += 68
