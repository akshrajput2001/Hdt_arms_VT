...
"""autogenerated by genpy from hdt_saffir_control/JointSpacePathActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class JointSpacePathActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "hdt_saffir_control/JointSpacePathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hdt_saffir_control/JointSpacePathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointSpacePathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hdt_saffir_control.msg.JointSpacePathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hdt_saffir_control.msg.JointSpacePathFeedback()
