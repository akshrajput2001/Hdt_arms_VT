...
"""autogenerated by genpy from hdt_saffir_control/JointSpacePathActionResult.msg. Do not edit."""
import codecs
import sys
...
class JointSpacePathActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hdt_saffir_control/JointSpacePathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hdt_saffir_control/JointSpacePathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointSpacePathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hdt_saffir_control.msg.JointSpacePathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hdt_saffir_control.msg.JointSpacePathResult()
