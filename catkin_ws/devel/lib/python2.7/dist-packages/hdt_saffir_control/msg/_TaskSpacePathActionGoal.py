...
"""autogenerated by genpy from hdt_saffir_control/TaskSpacePathActionGoal.msg. Do not edit."""
import codecs
import sys
...
class TaskSpacePathActionGoal(genpy.Message):
  _md5sum = "632465acfa71546721620b711f3ce36c"
  _type = "hdt_saffir_control/TaskSpacePathActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','hdt_saffir_control/TaskSpacePathGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskSpacePathActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = hdt_saffir_control.msg.TaskSpacePathGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = hdt_saffir_control.msg.TaskSpacePathGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.marker = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.marker = str[start:end]
      _x = self
      start = end
      end += 56
