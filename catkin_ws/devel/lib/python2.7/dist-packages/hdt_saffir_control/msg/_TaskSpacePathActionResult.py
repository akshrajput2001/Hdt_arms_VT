...
"""autogenerated by genpy from hdt_saffir_control/TaskSpacePathActionResult.msg. Do not edit."""
import codecs
import sys
...
class TaskSpacePathActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hdt_saffir_control/TaskSpacePathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hdt_saffir_control/TaskSpacePathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskSpacePathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hdt_saffir_control.msg.TaskSpacePathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hdt_saffir_control.msg.TaskSpacePathResult()
