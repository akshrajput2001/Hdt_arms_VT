...
int ArmControl::Init(void) {
    ...
    if(nh.getParam("robot_description", description)) {
        ...
        // move group
        move_group = new moveit::planning_interface::MoveGroupInterface(ARM_GROUP_NAME);
        //hand_move_group = new moveit::planning_interface::MoveGroupInterface(HAND_GROUP_NAME);
