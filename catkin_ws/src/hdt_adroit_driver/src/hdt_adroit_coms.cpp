...
// coms interfaces
//#include "hdt_pcan_interface.h"	// replaced by socketcan
...
int main(int argc, char **argv) {
	...
	else if(coms_interface == "dualcan") {
		std::vector<std::string> devices;
		devices.push_back("can0");
		devices.push_back("can1");
		//if(private_node_handle.getParam("devices", devices)) {
			COMS = new DualcanInterface(devices, 32);
		//}
		//else return -1;
	}
	else {
