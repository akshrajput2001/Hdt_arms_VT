...
int main(int argc, char **argv) {
	...
	EKG->AddSignal((char *)"hdt_common_test", (char *)"ticks", &ticks);

	float sinticks=sin(ticks);
	EKG->AddSignal((char *)"sin_hdt_common_test", (char *)"ticks", &sinticks);
