...
#include "hdt_saffir_left_control/JointSpacePathAction.h"
#include "hdt_saffir_left_control/TaskSpacePathAction.h"
#include "hdt_saffir_left_control/TrajectoryPathAction.h"
...
public:
	...
	actionlib::SimpleActionServer<hdt_saffir_left_control::TaskSpacePathAction> *task_space_path_as;
	actionlib::SimpleActionClient<hdt_saffir_left_control::TaskSpacePathAction> *task_space_path_ac;
	actionlib::SimpleActionServer<hdt_saffir_left_control::TrajectoryPathAction> *trajectory_path_as;
	actionlib::SimpleActionClient<hdt_saffir_left_control::TrajectoryPathAction> *trajectory_path_ac;
	...
	// callbacks
	void JointSpacePathCb(const hdt_saffir_left_control::JointSpacePathGoalConstPtr &goal);
	void TaskSpacePathCb(const hdt_saffir_left_control::TaskSpacePathGoalConstPtr &goal);
	void TrajectoryPathCb(const hdt_saffir_left_control::TrajectoryPathGoalConstPtr &goal);
